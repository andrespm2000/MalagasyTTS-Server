...
#Language detection model and tokenizer loading
classifModelName = "papluca/xlm-roberta-base-language-detection"
classifTokenizer = AutoTokenizer.from_pretrained(classifModelName)
classifModel = AutoModelForSequenceClassification.from_pretrained(classifModelName)

def detectar_idioma(texto, langmap):
    """
